...
<div id="page" class="<?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <header id="header" style="<?php //echo $header_style; ?>>
    ...
    <?php endif; ?>
      ...
      <?php if (theme_get_setting('socialicon_display', 'corp')): ?>
      <?php 
      $twitter_url = check_plain(theme_get_setting('twitter_url', 'corporate')); 
      $facebook_url = check_plain(theme_get_setting('facebook_url', 'corporate')); 
      $linkedin_url = check_plain(theme_get_setting('linkedin_url', 'corporate')); 
      $theme_path_social = base_path() . drupal_get_path('theme', 'corporate');
      ?>
      <div id="socialbar">
        <ul class="social">
  ...
  <!-- ______________________ PAGE BOTTOM _______________________ -->
  <div style="clear:both"></div>
  ...
  <?php if ($page['bottom_column_first'] | $page['bottom_column_second'] | $page['bottom_column_third'] )
        { ?>
          <div id="bottom-columns">
            <?php print corp_build_columns( array(
